...
<h1>Add Supplier</h1>
	<br>
<form:form action="${pageContext.request.contextPath}/saveSupplier" method="post" commandName="save_supplier" role="form">
		<table align="center">
			<tr>
			
				<td>Supplier Name</td>
				<td>
				<input type="hidden" name="supp_id" value="${supplierDetail.getSupp_id()}"/>
				<input type="text" name="supp_name" value="${supplierDetail.getSupp_name()}"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td>Supplier City</td>
				<td><input type="text" name="supp_city" value="${supplierDetail.getSupp_city()}"/></td>
			</tr>
			<tr>
				<td>Supplier Contact No.1</td>
				<td><input type="text" name="supp_contact1" value="${supplierDetail.getSupp_contact1()}"/></td>
			</tr>
			<tr>
				<td>Supplier Contact No.2</td>
				<td><input type="text" name="supp_contact2" value="${supplierDetail.getSupp_contact2()}"/></td>
			</tr>
			<tr>
				<td>Supplier Email</td>
				<td><input type="text" name="supp_email" value="${supplierDetail.getSupp_email()}"/></td>
			</tr>
			<tr>
				<td colspan="2">
